...
responses: Dict  = {
    "login": {"success": "Successful!","invalid_details": "Invalid login.","invalid_hwid": "Invalid hwid.","hwid_updated": "Hwid updated.","subscription_expired": "Subscription expired."},
    "register": {"success": "Successful!","invalid_license": "Invalid license.","email_used": "Email has been used already.","invalid_username": "Username is taken by another user."},
